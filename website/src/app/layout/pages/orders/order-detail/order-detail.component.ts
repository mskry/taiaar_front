...
export class OrderDetailComponent implements OnInit, OnDestroy {
  ...
  onAddItems() {
    ...
    if (this.settings.table_book_mac_theme == 1) {
      var table_booking_discount = this.orderHistory[this.selectedOrder].for_edit_order_table_booking_discount;
      var table_booking_actual_price = this.orderHistory[this.selectedOrder].for_edit_order_table_booking_price;
      let table_discount_price = (subTotal * table_booking_discount) / 100;
      if (table_discount_price > table_booking_actual_price) {
        payload['table_booking_fee'] = table_discount_price;
      }
      else {
        payload['table_booking_fee'] = table_booking_discount;
      }
    }
