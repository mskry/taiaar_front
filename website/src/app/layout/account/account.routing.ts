...
import { ChatNotificationsComponent } from './chat-notification/chat-notification.component';
...
export const AccountRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'chat_notifications', component: ChatNotificationsComponent,
        data: { title: 'Chat Notifications', breadcrumb: 'Chat Notifications' },
      },
      {
