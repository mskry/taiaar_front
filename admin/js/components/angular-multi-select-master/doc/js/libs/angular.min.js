...
(function(M, Y, t) {
    ...
    function Ob(b, a) {
        ...
        function h(b, c) {
            ...
            return {
                ...
                get: d,
                annotate: Vb,
                has: function(a) { return n.hasOwnProperty(a + "Provider") || b.hasOwnProperty(a) }
            }
        }
        a = !0 === a;
        var l = {},
            ...
            q = n.$injector = h(n, function(a, b) { ga.isString(b) && k.push(b); throw Ga("unpr", k.join(" <- ")); }),
            u = {},
    ...
    function pf(b, a, c, d) {
        ...
        m.defer.cancel = function(a) { return p[a] ? (delete p[a], O(a), e(H), !0) : !1 }
    }
                ...
                switch (a.nodeType) {
                    case oa:
                        ...
                        for (var k, q, n, r = a.attributes, p = 0, w = r && r.length; p < w; p++) {
                            ...
                            q = U(k.value);
                            k = ya(l);
                            if (n = fb.test(k)) l = l.replace(Rc, "").substr(8).replace(/_(.)/g, function(a, b) { return b.toUpperCase() });
    ...
    function Fe() {
        ...
        this.$get = ["$injector", "$window", function(d, e) {
            ...
            return function(g, h,
                ...
                if (l) return l = (D(g) ? g[g.length - 1] : g).prototype, m = Object.create(l || null), q && f(h, q, m, n || g.name), z(function() { d.invoke(g, m, h, n); return m }, { instance: m, identifier: q });
            ...
            function(e, f, g, h) {
                ...
                l.prototype = {
                    ...
                    $digest: function() {
                            ...
                            a: do {
                                if (m = t.$$watchers)
                                    for (u = m.length; u--;) try {
                                        if (e = m[u])
                                            if ((g = e.get(t)) !== (l = e.last) && !(e.eq ? fa(g, l) : "number" === typeof g && "number" === typeof l && isNaN(g) && isNaN(l))) v = !0, c = e, e.last = e.eq ? Ea(g, null) : g, e.fn(g, l === n ? g : l, t), 5 > s && (y = 4 - s, W[y] || (W[y] = []), W[y].push({ msg: G(e.exp) ? "fn: " + (e.exp.name || e.exp.toString()) : e.exp, newVal: g, oldVal: l }));
                        ...
                        for (r.$$phase = null; p.length;) try { p.shift()() } catch (ca) { f(ca) }
                    },
                    $destroy: function() {
                        if (!this.$$destroyed) {
                            var a =
    ...
    function jb(b, a, c, d) {
        return function(e, f, g, h, l, k, m) {
            ...
            if (y(g.min) || g.ngMin) {
                var s;
                h.$validators.min = function(a) { return !n(a) || A(s) || c(a) >= s };
            ...
            if (y(g.max) || g.ngMax) {
                var p;
                h.$validators.max = function(a) { return !n(a) || A(p) || c(a) <= p };
    ...
    s({
        ...
        R.prototype[c] = function(c, e, f) { for (var g, h = 0, l = this.length; h < l; h++) A(g) ? (g = a(this[h], c, e, f), y(g) && (g = B(g))) : Gc(g, a(this[h], c, e, f)); return y(g) ? g : this };
            ...
            return {
                ...
                link: function(d, e, f) {
                    ...
                    "href" === a && "[object SVGAnimatedString]" === Da.call(e.prop("href")) && (h = "xlinkHref", f.$attr[h] = "xlink:href",
                        g = null);
                    f.$observe(c, function(c) { c ? (f.$set(h, c), Ra && g && e.prop(g, f[h])) : "href" === a && f.$set(h, null) })
                }
            }
        }
    });
    ...
    var ie = ["$animate", function(a) {
        ...
        cg = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(a, c, d, e, f, g, h, l, k, m) {
            ...
            this.$$debounceViewValueCommit = function(c) {
                ...
                h.cancel(O);
                d ? O = h(function() { p.$commitViewValue() }, d) : l.$$phase ? p.$commitViewValue() : a.$apply(function() { p.$commitViewValue() })
            };
            a.$watch(function() {
                var c =
                    u(a);
        ...
        ne = ["$parse", "$animate", function(a, c) {
            ...
            return {
                ...
                compile: function(f, g) {
                    ...
                    var p, v, w, A, z = { $id: Na };
                    u ? p = a(u) : (w = function(a, c) { return Na(c) }, A = function(a) { return a });
                        ...
                        a.$watchCollection(n, function(g) {
                            ...
                            for (k = 0; k < H; k++)
                                if (S = g === G ? k : G[k], N = g[S], D = p(S, N, k), u[D]) C = u[D], delete u[D], z[D] = C, I[k] = C;
                                    ...
                                    if (z[D]) throw s(I, function(a) { a && a.scope && (u[a.id] = a) }), d("dupes", h, D, N);
